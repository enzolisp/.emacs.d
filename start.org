...
| SPC h r r | [[elisp:(lambda () (load-file "~/.config/emacs/init.el") (ignore(elpaca-process-queues)))][reload dtmacs]]     | eload dtmacs                       |
| SPC f u   | [[elisp:(sudo-find-file)][sudo-find-file]]    | Find file and open as root         |
| SPC f U   | [[elisp:(sudo-find-file)][sudo-find-file]]    | Open current file as root          |
